...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#343541] text-white font-nunito">
      <div className="max-w-sm mx-auto w-full">
        <div className="flex justify-center text-[#cdcdcd] md:mb-6">
          <svg
        ...
        {/* <h1 className="text-3xl text-center mb-6 font-semibold font-nunito">
          Chat <span className="bg-primary text-white inline-block px-1">GPT</span>
        </h1> */}
        {/* <p className="font-medium text-2xl">{loading ? "Processing" : "Login"}</p> */}
        <form onSubmit={handleLoginForm}>
          <div className="my-4">
            <label htmlFor="username" className="block mb-1 font-nunito">
              Email
            </label>
            <input
              type="email"
              ...
              required
              className="w-full font-nunito bg-transparent rounded-md outline-none border border-gray-400/80 focus:border-gray-400 py-3 px-4 transition-all ease-in-out duration-500"
            />
          </div>
          <div className="my-4">
            <label htmlFor="password" className="block mb-1 font-nunito">
              Password
            </label>
            <input
              type="password"
          ...
          <button
            type="submit"
            // onClick={HandleLogin}
            className="my-6 block w-full font-nunito rounded-md outline-none border border-primary bg-primary hover:bg-primary focus:border-primary py-3 px-4 transition-all ease-in-out duration-500"
          >
